        ...
        <div className='container m-2'>
        {
            doctors && (
              ...
              <h4> Timings : {doctors.timings && doctors.timings[0]} - {" "}
                ...
                <DatePicker aria-required={'true'} className="m-2" format="YYYY-MM-DD" onChange={(value)=>{ 
            ...
            <button className='btn btn-primary mt-2'onClick={handleAvailability}>Check Availablity</button>
